...
T = seq(300,700,by=25)    # Celsius
P = 500                  # bar
logfO2 = seq(-41,-15,by=2)

source("calcbufferfO2.R") # calculate/save to disk logfO2 buffered by mineral assemblages

# T = seq(300,700,by=100)    # Celsius
# P = 1000                  # bar
# logfO2 = seq(-42,-28,by=10)
...
write.csv(conds, "conds2o.csv")
write.csv(logaeq,"logaeq2o.csv", na = "NaN")

toc()

# 20 Mar 2017,  Calculated at 17 temperature and 12 logfO2 intervals (256
